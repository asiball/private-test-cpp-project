...
|---|---|---|---|---|---|---|---|---|---|---|
| 3 | 2025-06-01 | v1.0.1 | v1.1.0 | v1.1.0 | 7.5 | 5.10.x | RPi 3B+ | 山田 | GitHub Actions | 非同期API追加 |
| 2 | 2025-03-20 | v1.0.1 | v1.0.0 | v1.0.0 | 7.5 | 5.10.x | RPi 3B+ | 山田 | GitHub Actions | EAGAIN修正のみ |
| 1 | 2025-01-15 | v1.0.0 | v1.0.0 | v1.0.0 | 7.5 | 5.10.x | RPi 3B+ | 山田 | GitHub Actions | 初回リリース |
